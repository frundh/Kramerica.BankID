...
using Kramerica.BankID.OIDCServer.Helpers;
...
namespace Kramerica.BankID.OIDCServer.Controllers
{
    public class AuthorizationController : Controller
    {
        ...
        public async Task<IActionResult> Authorize(CancellationToken cancellationToken)
        {
            ...
            var application = GetApplication(request.ClientId, cancellationToken);
            if (application == null)
            {
                return View("Error", new OpenIdConnectResponse
                {
        ...
        protected virtual Client GetApplication(string identifier, CancellationToken cancellationToken)
        {
            ...
            return Config.Configuration.GetClients().Where(c=>c.ClientID==identifier).SingleOrDefault();
        }
    }
}